 ...
 */
public class ValuePrefixedCompiledTrieDict implements CompiledDictionary, Serializable {
     ...
     * pairs.
     */
    public ValuePrefixedCompiledTrieDict() {
...
//                System.out.println("value: " + new String(value.getBytes()) + " readValue: " + new String(readValue.getBytes()));
            }
            if ((valueFlag & 0x02) != 0) {
                prefixValue = value;
            }
...
//        System.out.println("keyOffset at end = " + keyOffset);
...
//            System.out.println("Writing value: " + new String(node.value.getBytes()));
